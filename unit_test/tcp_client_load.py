...
def create_tcp_client(aim = 'default'):
	...
	tcpclient.write('{"cmd":"getStatus", "args":"null"}\n')
	tcpclient.handle()
	
	tcpclient.write('{"cmd":"setStatus", "args":"o/"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"getStatus", "args":"null"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"message", "args":"[\'HELLO\', [\'*\']]"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"forward", "args":"[\'HELLO\', [\'*\']]", "app" : "irc"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"join", "args": ["irc"], "app" : "irc"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"part", "args": "irc", "app" : "irc"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"join", "args": ["irc"], "app" : "irc"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"auth", "args": "master", "app" : "irc"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"auth", "args": "admin", "app" : "irc"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"chanAuth", "args": "admin", "app" : "irc"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"timeConnect", "args": "null"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"create", "args": ["toto", "tata"]}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"join", "args": ["toto", "tata"], "app" : "toto"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"chanMasterPwd", "args": "joejoe", "app" : "toto"}\n')
	tcpclient.handle()
	tcpclient.write('{"cmd":"chanAuth", "args": "joejoe", "app" : "toto"}\n')
	tcpclient.handle()
	time.sleep(5)
